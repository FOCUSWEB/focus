...
-- ----------------------------
--  Table structure for `fcs_category`
-- ----------------------------
...
-- ----------------------------
--  Records of `fcs_category`
-- ----------------------------
BEGIN;
INSERT INTO `fcs_category` VALUES ('1', '杂七杂八', '乱七八糟的文章'), ('2', 'safaga', ' 阿什顿 地方'), ('3', 'safaga', ' 阿什顿 地方');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `fcs_user` VALUES ('1', 'focus', '$2y$10$SpJe3u78Q4VijuXFPw8iMeJ/MOl/rjsbdlvwdRJVB4RtSUL/ROP7G', 'pngsLLtmu6R7AmjzjWDrNlxzpNh8RFslxOQhGkeM6mRZKr2t4XkxoNrrJFO7', '2014-06-02 12:51:39'), ('2', 'tan', '$10$SpJe3u78Q4VijuXFPw8iMeJ/MOl/rjsbdlvwdRJVB4RtSUL/ROP7G', null, null);
COMMIT;
