...
<link href="{{ Config::get('site.adminAssetsPath') }}plugins/fullcalendar/fullcalendar.css" rel="stylesheet">
<link href="{{ Config::get('site.adminAssetsPath') }}plugins/metrojs/metrojs.css" rel="stylesheet">
@stop
@section('pageLevelScripts')
<script src="{{ Config::get('site.adminAssetsPath') }}plugins/metrojs/metrojs.min.js"></script>
<script src="{{ Config::get('site.adminAssetsPath') }}plugins/fullcalendar/moment.min.js"></script>
<script src="{{ Config::get('site.adminAssetsPath') }}plugins/fullcalendar/fullcalendar.min.js"></script>
<script src="{{ Config::get('site.adminAssetsPath') }}plugins/simple-weather/jquery.simpleWeather.min.js"></script>
<!--<script src="{{ Config::get('site.adminAssetsPath') }}plugins/google-maps/markerclusterer.js"></script>-->
<!--<!--<script src="http://maps.google.com/maps/api/js?sensor=true"></script>-->-->
<!--<!--<script src="{{ Config::get('site.adminAssetsPath') }}plugins/google-maps/gmaps.js"></script>-->-->
<script src="{{ Config::get('site.adminAssetsPath') }}plugins/charts-flot/jquery.flot.js"></script>
<script src="{{ Config::get('site.adminAssetsPath') }}plugins/charts-flot/jquery.flot.animator.min.js"></script>
<script src="{{ Config::get('site.adminAssetsPath') }}plugins/charts-flot/jquery.flot.resize.js"></script>
<script src="{{ Config::get('site.adminAssetsPath') }}plugins/charts-flot/jquery.flot.time.min.js"></script>
<script src="{{ Config::get('site.adminAssetsPath') }}plugins/charts-morris/raphael.min.js"></script>
<script src="{{ Config::get('site.adminAssetsPath') }}plugins/charts-morris/morris.min.js"></script>
<script
	src="{{ Config::get('site.adminAssetsPath') }}plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js"></script>
<script src="{{ Config::get('site.adminAssetsPath') }}js/calendar.js"></script>
<script src="{{ Config::get('site.adminAssetsPath') }}js/dashboard.js"></script>
@stop
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="withScroll" data-height="320">
						<a href="#" class="message-item media">
							<div class="media">
								<img src="{{ Config::get('site.adminAssetsPath') }}/img/avatars/avatar1.png" alt="avatar 1" width="40" class="pull-left">
						...
						<a href="#" class="message-item media">
							<div class="media">
								<img src="{{ Config::get('site.adminAssetsPath') }}/img/avatars/avatar2.png" alt="avatar 2" width="40" class="pull-left">
								<div class="media-body">
									<div class="pull-left">
						...
						<a href="#" class="message-item media">
							<div class="media">
								<img src="{{ Config::get('site.adminAssetsPath') }}/img/avatars/avatar3.png" alt="avatar 3" width="40" class="pull-left">
								<div class="media-body">
									<div class="pull-left">
										<p class="c-dark m-0"><strong>John Snow</strong></p>
										<p class="c-gray m-0">cameso@it.com</p>
						...
						<a href="#" class="message-item media">
							<div class="media">
								<img src="{{ Config::get('site.adminAssetsPath') }}/img/avatars/avatar4.png" alt="avatar 4" width="40" class="pull-left">
								<div class="media-body">
									<div class="pull-left">
										<p class="c-dark m-0"><strong>Jerry Smith</strong></p>
										<p class="c-gray m-0">bugomi@vigu.com</p>
						...
						<a href="#" class="message-item media">
							<div class="media">
								<img src="{{ Config::get('site.adminAssetsPath') }}/img/avatars/avatar5.png" alt="avatar 5" width="40" class="pull-left">
								<div class="media-body">
									<div class="pull-left">
										<p class="c-dark m-0"><strong>John Snow</strong></p>
										<p class="c-gray m-0">cameso@it.com</p>
						...
						<a href="#" class="message-item media">
							<div class="media">
								<img src="{{ Config::get('site.adminAssetsPath') }}/img/avatars/avatar6.png" alt="avatar 6" width="40" class="pull-left">
								<div class="media-body">
									<div class="pull-left">
										<p class="c-dark m-0"><strong>Jerry Smith</strong></p>
										<p class="c-gray m-0">bugomi@vigu.com</p>
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="withScroll" data-height="480">
							<a href="#" class="message-item media">
								<div class="media">
									<img src="{{ Config::get('site.adminAssetsPath') }}/img/avatars/avatar13.png" alt="avatar 13" width="50" class="pull-left">
									<div class="media-body">
							...
							<a href="#" class="message-item media">
								<div class="media">
									<img src="{{ Config::get('site.adminAssetsPath') }}/img/avatars/avatar12.png" alt="avatar 12" width="50" class="pull-left">
									<div class="media-body">
										<small class="pull-right">23 Sept</small>
							...
							<a href="#" class="message-item media">
								<div class="media">
									<img src="{{ Config::get('site.adminAssetsPath') }}/img/avatars/avatar11.png" alt="avatar 11" width="50" class="pull-left">
									<div class="media-body">
										<small class="pull-right">23 Sept</small>
										<h5 class="c-dark"><strong>John Snow</strong></h5>
										<h4 class="c-dark">Reset your account password</h4>
							...
							<a href="#" class="message-item media">
								<div class="media">
									<img src="{{ Config::get('site.adminAssetsPath') }}/img/avatars/avatar10.png" alt="avatar 10" width="50" class="pull-left">
									<div class="media-body">
										<small class="pull-right">23 Sept</small>
										<h5 class="c-dark"><strong>Jerry Smith</strong></h5>
										<h4 class="c-dark">Check Dropbox</h4>
							...
							<a href="#" class="message-item media">
								<div class="media">
									<img src="{{ Config::get('site.adminAssetsPath') }}/img/avatars/avatar9.png" alt="avatar 9" width="50" class="pull-left">
									<div class="media-body">
										<small class="pull-right">23 Sept</small>
										<h5 class="c-dark"><strong>John Snow</strong></h5>
										<h4 class="c-dark">Reset your account password</h4>
							...
							<a href="#" class="message-item media">
								<div class="media">
									<img src="{{ Config::get('site.adminAssetsPath') }}/img/avatars/avatar8.png" alt="avatar 8" width="50" class="pull-left">
									<div class="media-body">
										<small class="pull-right">23 Sept</small>
										<h5 class="c-dark"><strong>Jerry Smith</strong></h5>
										<h4 class="c-dark">Check Dropbox</h4>
							...
							<a href="#" class="message-item media">
								<div class="media">
									<img src="{{ Config::get('site.adminAssetsPath') }}/img/avatars/avatar7.png" alt="avatar 7" width="50" class="pull-left">
									<div class="media-body">
										<small class="pull-right">23 Sept</small>
										<h5 class="c-dark"><strong>John Snow</strong></h5>
										<h4 class="c-dark">Reset your account password</h4>
