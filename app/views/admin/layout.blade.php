...
<head>
	...
	<link href="{{ Config::get('site.adminAssetsPath') }}plugins/timepicker/bootstrap-timepicker.min.css" rel="stylesheet">
	...
	<link href="{{ Config::get('site.adminAssetsPath') }}plugins/datatable/css/bootstrap.datatable.min.css" rel="stylesheet">
...
<div class="logo-brand">
	<a href="index.html"><img src="{{ Config::get('site.adminAssetsPath') }}img/sentir-logo-primary.png" alt="Sentir logo"></a>
</div><!-- /.logo-brand -->
<!-- End Logo brand -->
...
<ul class="nav-user navbar-right">
	<li class="dropdown">
		<a href="#fakelink" class="dropdown-toggle" data-toggle="dropdown">
			<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-1.jpg" class="avatar img-circle" alt="Avatar">
			...
			<div class="nav-dropdown-content scroll-nav-dropdown">
				<ul>
					<li class="unread"><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-2.jpg" class="absolute-left-content img-circle" alt="Avatar">
							<strong>Thomas White</strong> posted on your profile page
							<span class="small-caps">17 seconds ago</span>
						</a></li>
					<li class="unread"><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-3.jpg" class="absolute-left-content img-circle" alt="Avatar">
							<strong>Doina Slaivici</strong> uploaded photo
							<span class="small-caps">10 minutes ago</span>
						</a></li>
					<li><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-4.jpg" class="absolute-left-content img-circle" alt="Avatar">
							<strong>Harry Nichols</strong> commented on your post
							<span class="small-caps">40 minutes ago</span>
						</a></li>
					<li class="unread"><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-5.jpg" class="absolute-left-content img-circle" alt="Avatar">
							<strong>Mihaela Cihac</strong> send you a message
							<span class="small-caps">2 hours ago</span>
						</a></li>
					<li class="unread"><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-6.jpg" class="absolute-left-content img-circle" alt="Avatar">
							<strong>Harold Chavez</strong> change his avatar
							<span class="small-caps">Yesterday</span>
						</a></li>
					<li class="unread"><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-7.jpg" class="absolute-left-content img-circle" alt="Avatar">
							<strong>Elizabeth Owens</strong> posted on your profile page
							<span class="small-caps">Yesterday</span>
						</a></li>
					<li class="unread"><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-8.jpg" class="absolute-left-content img-circle" alt="Avatar">
							<strong>Frank Oliver</strong> commented on your post
							<span class="small-caps">A week ago</span>
						</a></li>
					<li><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-9.jpg" class="absolute-left-content img-circle" alt="Avatar">
							<strong>Mya Weastell</strong> send you a message
							<span class="small-caps">April 15, 2014</span>
						</a></li>
					<li><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-10.jpg" class="absolute-left-content img-circle" alt="Avatar">
	...
	<ul class="dropdown-menu square margin-list-rounded with-triangle">
		<li>
			...
			<div class="nav-dropdown-content scroll-nav-dropdown">
				<ul>
					<li class="unread"><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-25.jpg" class="absolute-left-content img-circle" alt="Avatar">
							Lorem ipsum dolor sit amet, consectetuer adipiscing elit
							<span class="small-caps">17 seconds ago</span>
						</a></li>
					<li class="unread"><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-24.jpg" class="absolute-left-content img-circle" alt="Avatar">
							Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat
							<span class="small-caps">10 minutes ago</span>
						</a></li>
					<li><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-23.jpg" class="absolute-left-content img-circle" alt="Avatar">
							I think so
							<span class="small-caps">40 minutes ago</span>
						</a></li>
					<li class="unread"><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-22.jpg" class="absolute-left-content img-circle" alt="Avatar">
							Yes, I'll be waiting
							<span class="small-caps">2 hours ago</span>
						</a></li>
					<li class="unread"><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-21.jpg" class="absolute-left-content img-circle" alt="Avatar">
							Thank you!
							<span class="small-caps">Yesterday</span>
						</a></li>
					<li class="unread"><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-20.jpg" class="absolute-left-content img-circle" alt="Avatar">
							No problem! I will never remember that
							<span class="small-caps">Yesterday</span>
						</a></li>
					<li class="unread"><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-19.jpg" class="absolute-left-content img-circle" alt="Avatar">
							Tak gepuk ndasmu sisan lho dab!
							<span class="small-caps">A week ago</span>
						</a></li>
					<li><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-18.jpg" class="absolute-left-content img-circle" alt="Avatar">
							Sorry bro, aku or atau sing jenenge ngono kui
							<span class="small-caps">April 15, 2014</span>
						</a></li>
					<li><a href="#fakelink">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-17.jpg" class="absolute-left-content img-circle" alt="Avatar">
	...
	<ul class="dropdown-menu square margin-list-rounded with-triangle">
		<li>
			...
			<div class="nav-dropdown-content static-list scroll-nav-dropdown">
				<ul>
					<li>
						<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-12.jpg" class="absolute-left-content img-circle" alt="Avatar">
						<div class="row">
							<div class="col-xs-6">
					...
					<li>
						<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-13.jpg" class="absolute-left-content img-circle" alt="Avatar">
						<div class="row">
							<div class="col-xs-6">
					...
					<li>
						<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-14.jpg" class="absolute-left-content img-circle" alt="Avatar">
						<div class="row">
							<div class="col-xs-6">
					...
					<li>
						<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-15.jpg" class="absolute-left-content img-circle" alt="Avatar">
						<div class="row">
							<div class="col-xs-6">
					...
					<li>
						<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-16.jpg" class="absolute-left-content img-circle" alt="Avatar">
						<div class="row">
							<div class="col-xs-6">
...
<?php
$sidebar = new FSidebar();
$sidebar->htmlOptions = array('class' => "sidebar-menu");
$sidebar->items = array(
	array(
		'label' => '仪表盘',
		'url' => URL::route('adminDashboard'),
		'icon' => 'dashboard',
		'active' => Route::getCurrentRoute()->getName() == 'adminDashboard',
	),
	array(
		'label' => '文章',
		'url' => URL::route('adminPost'),
		'icon' => 'archive',
		'active' => Route::getCurrentRoute()->getPrefix() == 'admin/post',
	),
);
$sidebar->make();
?>
...
<div class="tab-pane fade in active" id="online-user-sidebar">
	<ul class="sidebar-menu online-user">
		...
		<li><a href="#fakelink">
				...
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-2.jpg" class="ava-sidebar img-circle" alt="Avatar">
		...
		<li><a href="#fakelink">
				<span class="user-status success"></span>
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-3.jpg" class="ava-sidebar img-circle" alt="Avatar">
				Doina Slaivici
				<span class="small-caps">Duis autem vel eum iriure dolor in hendrerit in </span>
			</a></li>
		<li><a href="#fakelink">
				<span class="user-status success"></span>
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-4.jpg" class="ava-sidebar img-circle" alt="Avatar">
		...
		<li><a href="#fakelink">
				<span class="user-status success"></span>
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-5.jpg" class="ava-sidebar img-circle" alt="Avatar">
				<i class="fa fa-mobile-phone device-status"></i>
				Mihaela Cihac
		...
		<li><a href="#fakelink">
				<span class="user-status success"></span>
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-6.jpg" class="ava-sidebar img-circle" alt="Avatar">
		...
		<li><a href="#fakelink">
				...
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-7.jpg" class="ava-sidebar img-circle" alt="Avatar">
		...
		<li><a href="#fakelink">
				<span class="user-status warning"></span>
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-8.jpg" class="ava-sidebar img-circle" alt="Avatar">
				<i class="fa fa-apple device-status"></i>
				Frank Oliver
		...
		<li><a href="#fakelink">
				<span class="user-status warning"></span>
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-9.jpg" class="ava-sidebar img-circle" alt="Avatar">
				Mya Weastell
				<span class="small-caps">15 minutes</span>
			</a></li>
		<li><a href="#fakelink">
				<span class="user-status warning"></span>
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-10.jpg" class="ava-sidebar img-circle" alt="Avatar">
				<i class="fa fa-mobile-phone device-status"></i>
				Carl Rodriguez
		...
		<li><a href="#fakelink">
				<span class="user-status warning"></span>
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-11.jpg" class="ava-sidebar img-circle" alt="Avatar">
				<i class="fa fa-mobile-phone device-status"></i>
				Nikita Carter
		...
		<li><a href="#fakelink">
				...
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-12.jpg" class="ava-sidebar img-circle" alt="Avatar">
				Craig Dixon
				<span class="small-caps">Last seen 2 hours ago</span>
			</a></li>
		<li><a href="#fakelink">
				<span class="user-status danger"></span>
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-13.jpg" class="ava-sidebar img-circle" alt="Avatar">
				Mikayla King
				<span class="small-caps">Last seen yesterday</span>
			</a></li>
		<li><a href="#fakelink">
				<span class="user-status danger"></span>
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-14.jpg" class="ava-sidebar img-circle" alt="Avatar">
				Richard Dixon
				<span class="small-caps">Last seen Feb 20, 2014 05:45:50</span>
			</a></li>
		<li><a href="#fakelink">
				<span class="user-status danger"></span>
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-15.jpg" class="ava-sidebar img-circle" alt="Avatar">
				Brenda Fuller
				<span class="small-caps">Last seen Feb 15, 2014 11:35:50</span>
			</a></li>
		<li><a href="#fakelink">
				<span class="user-status danger"></span>
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-16.jpg" class="ava-sidebar img-circle" alt="Avatar">
				Ryan Ortega
...
<div class="tab-pane fade" id="notification-sidebar">
	<ul class="sidebar-menu sidebar-notification">
		...
		<li><a href="#fakelink" data-toggle="tooltip" title="Karen Wallace" data-placement="left">
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-25.jpg" class="ava-sidebar img-circle" alt="Avatar">
		...
		<li><a href="#fakelink" data-toggle="tooltip" title="Phillip Lucas" data-placement="left">
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-24.jpg" class="ava-sidebar img-circle" alt="Avatar">
				<span class="activity">Uploaded a photo</span>
				<span class="small-caps">2 hours ago</span>
			</a></li>
		<li><a href="#fakelink" data-toggle="tooltip" title="Sandra Myers" data-placement="left">
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-23.jpg" class="ava-sidebar img-circle" alt="Avatar">
		...
		<li><a href="#fakelink" data-toggle="tooltip" title="Charles Guerrero" data-placement="left">
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-22.jpg" class="ava-sidebar img-circle" alt="Avatar">
		...
		<li><a href="#fakelink" data-toggle="tooltip" title="Maria Simpson" data-placement="left">
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-21.jpg" class="ava-sidebar img-circle" alt="Avatar">
		...
		<li><a href="#fakelink" data-toggle="tooltip" title="Jason Crawford" data-placement="left">
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-20.jpg" class="ava-sidebar img-circle" alt="Avatar">
				<span class="activity">Posted something on your profile page</span>
		...
		<li><a href="#fakelink" data-toggle="tooltip" title="Cynthia Mendez" data-placement="left">
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-19.jpg" class="ava-sidebar img-circle" alt="Avatar">
				<span class="activity">Uploaded a photo</span>
		...
		<li><a href="#fakelink" data-toggle="tooltip" title="Peter Ramirez" data-placement="left">
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-18.jpg" class="ava-sidebar img-circle" alt="Avatar">
				<span class="activity">Commented on your post</span>
		...
		<li><a href="#fakelink" data-toggle="tooltip" title="Jessica Gutierrez" data-placement="left">
				<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-17.jpg" class="ava-sidebar img-circle" alt="Avatar">
				<span class="activity">Send you a message</span>
			...
			<div class="panel panel-danger panel-square panel-no-border task-list-wrap">
				...
				<div class="the-box full no-border property-card">
					<div id="property-slide-8" class="owl-carousel">
						<div class="item full"><img src="{{ Config::get('site.adminAssetsPath') }}img/photo/small/img-15.jpg" alt="Image"></div>
						<div class="item full"><img src="{{ Config::get('site.adminAssetsPath') }}img/photo/small/img-16.jpg" alt="Image"></div>
						<div class="item full"><img src="{{ Config::get('site.adminAssetsPath') }}img/photo/small/img-17.jpg" alt="Image"></div>
					</div>
...
<div class="col-lg-4">
	...
	<div class="the-box no-border" id="weather-widget-1">
		...
		<div class="weather-widget">
			<div class="row">
				...
				<div class="col-xs-6">
					<h1 class="bolded degrees white-text">28<i class="wi wi-degrees"></i></h1>
		...
		<div class="row">
			<div class="col-xs-4 text-center">
				...
				<h4 class="bolded white-text">27<i class="wi wi-degrees"></i></h4>
			</div><!-- /.col-xs-4 -->
			<div class="col-xs-4 text-center">
				<h4 class="white-text">SUN</h4>
				<canvas id="fog" width="50" height="50"></canvas>
				<h4 class="bolded white-text">26<i class="wi wi-degrees"></i></h4>
			</div><!-- /.col-xs-4 -->
			<div class="col-xs-4 text-center">
				<h4 class="white-text">MON</h4>
				<canvas id="snow" width="50" height="50"></canvas>
				<h4 class="bolded white-text">15<i class="wi wi-degrees"></i></h4>
			</div><!-- /.col-xs-4 -->
		</div><!-- /.row -->
	...
	<div class="the-box bg-success no-border">
		<div class="media user-card-sm">
			<a class="pull-left" href="#fakelink">
				<img class="media-object img-circle" src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-9.jpg" alt="Avatar">
			</a>
	...
	<div class="the-box no-border">
		<div class="media user-card-sm">
			<a class="pull-left" href="#fakelink">
				<img class="media-object img-circle" src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-7.jpg" alt="Avatar">
			</a>
			<div class="media-body">
	...
	<div class="the-box no-border">
		<div class="media user-card-sm">
			<a class="pull-left" href="#fakelink">
				<img class="media-object img-circle" src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-6.jpg" alt="Avatar">
			</a>
			<div class="media-body">
			...
			<div class="col-sm-6 col-md-6 col-lg-12">
				...
				<div class="the-box bg-warning no-border full">
					<div id="tiles-slide-2" class="owl-carousel tiles-carousel">
						<div class="item full">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-1.jpg" class="avatar img-circle has-white-shadow" alt="avatar">
							<div class="des">
							...
							<img src="{{ Config::get('site.adminAssetsPath') }}img/photo/medium/img-14.jpg" alt="Image">
						</div><!-- /.item full -->
						<div class="item full">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-2.jpg" class="avatar img-circle has-white-shadow" alt="avatar">
							<div class="des">
								<h4 class="bolded"><a href="#fakelink">Awesome headline news title</a></h4>
								<p class="small">01 MAY, 2014</p>
								<p class="small">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh</p>
							</div>
							<img src="{{ Config::get('site.adminAssetsPath') }}img/photo/medium/img-12.jpg" alt="Image">
						</div><!-- /.item full -->
						<div class="item full">
							<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-3.jpg" class="avatar img-circle has-white-shadow" alt="avatar">
							<div class="des">
								<h4 class="bolded"><a href="#fakelink">Awesome headline news title</a></h4>
								<p class="small">29 APRIL, 2014</p>
								<p class="small">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh</p>
							</div>
							<img src="{{ Config::get('site.adminAssetsPath') }}img/photo/medium/img-13.jpg" alt="Image">
						</div><!-- /.item full -->
					</div><!-- /#tiles-slide-2 -->
				</div><!-- /.the-box no-border full -->
					...
					<div id="tiles-slide-3" class="owl-carousel tiles-carousel-color">
						<div class="item full">
							<div class="avatar-wrap">
								<div class="media">
									<a class="pull-left" href="#fakelink">
										<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-1.jpg" class="avatar img-circle has-white-shadow media-object" alt="avatar">
									</a>
									<div class="media-body">
						...
						<div class="item full">
							<div class="avatar-wrap">
								<div class="media">
									<a class="pull-left" href="#fakelink">
										<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-2.jpg" class="avatar img-circle has-white-shadow media-object" alt="avatar">
									</a>
									<div class="media-body">
						...
						<div class="item full">
							<div class="avatar-wrap">
								<div class="media">
									<a class="pull-left" href="#fakelink">
										<img src="{{ Config::get('site.adminAssetsPath') }}img/avatar/avatar-3.jpg" class="avatar img-circle has-white-shadow media-object" alt="avatar">
									</a>
									<div class="media-body">
...
<div class="the-box no-border">
	...
	<div id="store-item-carousel-3" class="owl-carousel shop-carousel">
		<div class="item">
			<div class="media">
				<a class="pull-left" href="#fakelink">
					<img class="media-object sm" src="{{ Config::get('site.adminAssetsPath') }}img/shop/img-shop-1.jpg" alt="Image">
				</a>
				<div class="media-body">
		...
		<div class="item">
			<div class="media">
				<a class="pull-left" href="#fakelink">
					<img class="media-object sm" src="{{ Config::get('site.adminAssetsPath') }}img/shop/img-shop-2.jpg" alt="Image">
				</a>
				<div class="media-body">
					<h4 class="media-heading"><a href="#fakelink">Product name here</a></h4>
					<p class="brand">BRAND NAME</p>
		...
		<div class="item">
			<div class="media">
				<a class="pull-left" href="#fakelink">
					<img class="media-object sm" src="{{ Config::get('site.adminAssetsPath') }}img/shop/img-shop-3.jpg" alt="Image">
				</a>
				<div class="media-body">
					<h4 class="media-heading"><a href="#fakelink">Product name here</a></h4>
					<p class="brand">BRAND NAME</p>
		...
		<div class="item">
			<div class="media">
				<a class="pull-left" href="#fakelink">
					<img class="media-object sm" src="{{ Config::get('site.adminAssetsPath') }}img/shop/img-shop-4.jpg" alt="Image">
				</a>
				<div class="media-body">
					<h4 class="media-heading"><a href="#fakelink">Product name here</a></h4>
					<p class="brand">BRAND NAME</p>
		...
		<div class="item">
			<div class="media">
				<a class="pull-left" href="#fakelink">
					<img class="media-object sm" src="{{ Config::get('site.adminAssetsPath') }}img/shop/img-shop-5.jpg" alt="Image">
				</a>
				<div class="media-body">
					<h4 class="media-heading"><a href="#fakelink">Product name here</a></h4>
					<p class="brand">BRAND NAME</p>
		...
		<div class="item">
			<div class="media">
				<a class="pull-left" href="#fakelink">
					<img class="media-object sm" src="{{ Config::get('site.adminAssetsPath') }}img/shop/img-shop-6.jpg" alt="Image">
				</a>
				<div class="media-body">
					<h4 class="media-heading"><a href="#fakelink">Product name here</a></h4>
					<p class="brand">BRAND NAME</p>
	...
	<div class="col-sm-8">
		...
		<div class="the-box full no-border item-lg">
			<div id="store-item-carousel-2" class="owl-carousel">
				<div class="item full"><img src="{{ Config::get('site.adminAssetsPath') }}img/photo/large/img-7.jpg" class="item-image" alt="Image"></div>
				<div class="item full"><img src="{{ Config::get('site.adminAssetsPath') }}img/photo/large/img-8.jpg" class="item-image" alt="Image"></div>
			</div>
			<div class="item-des">
